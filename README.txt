...
1. Put LouGeh Project Monitoring folder in your localhost.
2. Get your XAMPP running and start the Apache and MySQL services.
4. Go to http://localhost/phpmyadmin and import the sql file.
